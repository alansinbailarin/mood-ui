...
import { Typography, eventColorClass, eventColorClassStrong, hexToRgba } from "mood-ui";
...
useSeoMeta({
  ...
  ogTitle: () => `${t("pages.utilities.eventColors.title")} · mood-ui`,
  ogDescription: () => t("pages.utilities.eventColors.description"),
});
