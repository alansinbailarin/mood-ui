...
import { Button, Drawer, FormField, Input, Select, Textarea, Typography } from "mood-ui";
...
useSeoMeta({
  ...
  ogTitle: () => `${t("pages.feedback.drawer.title")} · mood-ui`,
  ogDescription: () => t("pages.feedback.drawer.description"),
});
// ── A11y data ─────────────────────────────────────────────────────────────────
