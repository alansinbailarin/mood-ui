...
import { Button, NumberInput, Pagination, Typography } from "mood-ui";
...
useSeoMeta({
  ...
  ogTitle: () => `${t("pages.navigation.pagination.title")} · mood-ui`,
  ogDescription: () => t("pages.navigation.pagination.description"),
});
// ── A11y data ─────────────────────────────────────────────────────────────────
