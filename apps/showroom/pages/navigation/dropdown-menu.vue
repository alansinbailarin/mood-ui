...
import { DropdownMenu, Typography } from "mood-ui";
...
useSeoMeta({
  ...
  ogTitle: () => `${t("pages.navigation.dropdownMenu.title")} · mood-ui`,
  ogDescription: () => t("pages.navigation.dropdownMenu.description"),
});
// ── A11y data ─────────────────────────────────────────────────────────────────
