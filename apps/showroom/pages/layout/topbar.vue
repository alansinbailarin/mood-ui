...
import { Avatar, Button, SearchInput, Topbar, Typography } from "mood-ui";
...
useSeoMeta({
  ...
  ogTitle: () => `${t("pages.layout.topbar.title")} · mood-ui`,
  ogDescription: () => t("pages.layout.topbar.description"),
});
// ── A11y data ─────────────────────────────────────────────────────────────────
