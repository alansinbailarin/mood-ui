...
import { FormField, Input, Select, Textarea, Typography } from "mood-ui";
...
useSeoMeta({
  ...
  ogTitle: () => `${t("pages.forms.formField.title")} · mood-ui`,
  ogDescription: () => t("pages.forms.formField.description"),
});
// ── A11y data ─────────────────────────────────────────────────────────────────
