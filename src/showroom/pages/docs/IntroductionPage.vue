...
const principles = computed(() => [
    { icon: SwatchIcon,      title: t('pages.docs.introduction.principles.theming.title'),   text: t('pages.docs.introduction.principles.theming.text')   },
    { icon: GlobeAltIcon,    title: t('pages.docs.introduction.principles.i18n.title'),      text: t('pages.docs.introduction.principles.i18n.text')      },
    { icon: ShieldCheckIcon, title: t('pages.docs.introduction.principles.a11y.title'),      text: t('pages.docs.introduction.principles.a11y.text')      },
    { icon: BoltIcon,        title: t('pages.docs.introduction.principles.treeShake.title'), text: t('pages.docs.introduction.principles.treeShake.text') },
    { icon: PuzzlePieceIcon, title: t('pages.docs.introduction.principles.tailwind.title'),  text: t('pages.docs.introduction.principles.tailwind.text')  },
    { icon: CodeBracketIcon, title: t('pages.docs.introduction.principles.ts.title'),        text: t('pages.docs.introduction.principles.ts.text')        },
]);
</script>
    ...
    <article class="prose prose-neutral dark:prose-invert max-w-none flex flex-col gap-12 pb-12">
        ...
        <section v-reveal class="flex flex-col gap-4 not-prose">
            ...
            <div class="grid sm:grid-cols-2 gap-3">
                ...
                >
                    <h3 class="text-base font-semibold text-foreground !m-0 mb-1">{{ t('docsNav.installation') }}</h3>
                    <p class="text-sm text-muted-foreground !m-0">{{ t('pages.docs.introduction.tiles.installation.desc') }}</p>
                    <span class="inline-flex items-center gap-1 text-primary text-sm font-medium mt-2 group-hover:gap-2 transition-all">
                        {{ t('pages.docs.introduction.tiles.installation.cta') }} <ArrowRightIcon class="size-4" />
                    </span>
                </button>
                <button
                    type="button"
                    ...
                    @click="go('theming')"
                >
                    <h3 class="text-base font-semibold text-foreground !m-0 mb-1">{{ t('docsNav.theming') }}</h3>
                    <p class="text-sm text-muted-foreground !m-0">{{ t('pages.docs.introduction.tiles.theming.desc') }}</p>
                    <span class="inline-flex items-center gap-1 text-primary text-sm font-medium mt-2 group-hover:gap-2 transition-all">
                        {{ t('pages.docs.introduction.tiles.theming.cta') }} <ArrowRightIcon class="size-4" />
                    </span>
                </button>
                <button
                    type="button"
                    ...
                    @click="go('i18n')"
                >
                    <h3 class="text-base font-semibold text-foreground !m-0 mb-1">{{ t('docsNav.i18n') }}</h3>
                    <p class="text-sm text-muted-foreground !m-0">{{ t('pages.docs.introduction.tiles.i18n.desc') }}</p>
                    <span class="inline-flex items-center gap-1 text-primary text-sm font-medium mt-2 group-hover:gap-2 transition-all">
                        {{ t('pages.docs.introduction.tiles.i18n.cta') }} <ArrowRightIcon class="size-4" />
                    </span>
                </button>
                <button
                    type="button"
                    ...
                    @click="go('changelog')"
                >
                    <h3 class="text-base font-semibold text-foreground !m-0 mb-1">{{ t('docsNav.changelog') }}</h3>
                    <p class="text-sm text-muted-foreground !m-0">{{ t('pages.docs.introduction.tiles.changelog.desc') }}</p>
                    <span class="inline-flex items-center gap-1 text-primary text-sm font-medium mt-2 group-hover:gap-2 transition-all">
                        {{ t('pages.docs.introduction.tiles.changelog.cta') }} <ArrowRightIcon class="size-4" />
                    </span>
                </button>
            </div>
        </section>
