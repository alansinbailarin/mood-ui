...
export interface ModoLocale {
  ...
  avatarUpload: {
    /** Accessible label for the upload dropzone button. */
    uploadLabel: string;
    /** Body text inside the dropzone when empty. */
    dragPrompt: string;
    ...
    cropConfirm: string;
    cropReset: string;
    /** Default placeholder for the AI prompt input. */
    promptPlaceholder: string;
    /** Accessible label for the variant selector group. */
    variantLabel: string;
    /** Accessible label for the prompt suggestions chip group. */
    promptSuggestionsLabel: string;
    /** Screen-reader live announcement while generating. */
    generating: string;
    /** Screen-reader live announcement on success. */
    generated: string;
    saving: string;
    saved: string;
    ...
    errorUpload: string;
    errorSave: string;
    /** `{limit}` placeholder: human-readable size (e.g. "5 MB"). */
    errorSize: string;
    /** `{types}` placeholder: comma-separated list of allowed formats. */
    errorType: string;
    /** Badge label shown on AI-generated avatars. */
    aiLabel: string;
  };
  phoneInput: {
    /** aria-label on the country selector button. */
    selectCountry: string;
    /** Placeholder inside the country search box. */
    searchCountry: string;
    /** Empty state when country search returns no matches. */
    noResults: string;
  };
  otpInput: {
    /** Prefix for per-slot aria-label: "Digit 1", "Digit 2"… */
    digit: string;
  };
  /**
...
export const defaultLocale: ModoLocale = {
  ...
  avatarUpload: {
    uploadLabel: "Upload avatar. Drag an image or press Enter to browse",
    dragPrompt: "Drag an image or click to browse",
    ...
    cropReset: "Reset",
    promptPlaceholder: "Describe how you want to look…",
    variantLabel: "Visual style",
    promptSuggestionsLabel: "Quick prompts",
    generating: "Generating avatar…",
    generated: "Avatar generated successfully",
    saving: "Saving avatar…",
    saved: "Avatar saved",
    errorGenerate: "Failed to generate avatar",
    errorUpload: "Failed to process the image",
    errorSave: "Failed to save avatar",
    errorSize: "File exceeds the maximum size of {limit}",
    errorType: "Format not allowed. Use {types}",
